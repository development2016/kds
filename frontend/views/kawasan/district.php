    ...
    <div class="page-content">
        <div class="container">
            ...
            <ul class="page-breadcrumb breadcrumb">
                ...
                <li class="active">
                     Kawasan Perlaksanaan Negeri<i class="fa fa-circle"></i>
                </li>
                <li class="active">
                     Kawasan Perlaksanaan Daerah
                </li>
            </ul>
            <!-- END PAGE BREADCRUMB -->
			<div class="row">
					...
					<div class="portlet light">
						<div class="portlet-title">
                            <div class="caption font-green-haze">
                                ...
                                <span class="caption-subject bold uppercase"> Ringkasan Bagi Daerah : <?= $model->district ?></span>
                            </div>
