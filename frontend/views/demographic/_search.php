            ...
            <div class="form-body">
                <div class="col-md-12">
                    <div class="form-group form-md-line-input">
                        ...
                        <label for="form_control_1"><?= Html::activeLabel($model,'nama_ketua_kampung'); ?></label>
                ...
                <div class="col-md-4">
                    <div class="form-group form-md-line-input">
                       <?= Html::activeDropDownList($model, 'district_id', $district, 
                        [
                            'prompt'=>'','id'=>'district',
                            'onchange'=>'$.post( "'.Yii::$app->urlManager->createUrl(['demographic/getkampung','id'=>'']).'"+$(this).val(), function( data ) {$( "select#kampung" ).html( data );});',
                ...
                <div class="col-md-4">
                    <div class="form-group form-md-line-input">
                        ...
                        'onchange'=>'$.post( "'.Yii::$app->urlManager->createUrl(['demographic/getdistrict','id'=>'']).'"+$(this).val(), function( data ) {$( "select#district" ).html( data );});',
