...
class UserSearch extends User
{
    ...
    {
        return [
            [['id', 'role', 'negara_area_id', 'state_area_id', 'district_area_id', 'sub_base_area_id', 'cluster_area_id', 'kampung_area_id', 'status', 'created_at', 'updated_at'], 'integer'],
            [['username', 'nama', 'email', 'address', 'ic_no', 'mobile_no', 'home_no', 'no_tel_pej', 'img', 'pendapatan', 'pekerjaan', 'jawatan', 'mukim', 'kampung', 'negara', 'negeri', 'daerah', 'kewarganegaraan', 'status_perkahwinan', 'bangsa', 'agama', 'jantina', 'bank', 'no_akaun', 'tarikh_lahir', 'tempat_lahir', 'ic_no_old', 'poskod', 'status_area', 'tarikh_daftar_kerja', 'auth_key', 'password_hash', 'password_reset_token'], 'safe'],
        ];
    }
