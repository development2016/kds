...
use backend\models\CountStateSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * CountStateController implements the CRUD actions for CountState model.
 */
class CountStateController extends Controller
{
    ...
    /**
     * Lists all CountState models.
     * @return mixed
     */
    public function actionIndex()
    {
        $searchModel = new CountStateSearch();
    ...
    public function actionCalculate($id)
    {
        ...
        $sql = $connection->createCommand('SELECT COUNT(DISTINCT(temp_id)) as jumlah, field_id
                ...
                AND people.state_id = '.$id.') as temp_table
                GROUP BY field_id');
        ...
        $model = CountState::find()->where(['state_id'=>$id])->one();
    ...
    /**
     * Displays a single CountState model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Creates a new CountState model.
     * If creation is successful, the browser will be redirected to the 'view' page.
     * @return mixed
     */
    public function actionCreate()
    {
        $model = new CountState();
    ...
    /**
     * Updates an existing CountState model.
    ...
    /**
     * Deletes an existing CountState model.
    ...
    /**
     * Finds the CountState model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return CountState the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = CountState::findOne($id)) !== null) {
            return $model;
        } else {
