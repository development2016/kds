...
use common\models\LookupFieldSearch;
...
/**
 * LookupFieldController implements the CRUD actions for LookupField model.
 */
class LookupFieldController extends Controller
{
