...
/**
 * UserMicroSearch represents the model behind the search form about `backend\models\User`.
 */
class UserMicroSearch extends User
{
    /**
     * @inheritdoc
     */
    ...
    {
        $query = User::find()->where(['role'=>[5,12]]);
