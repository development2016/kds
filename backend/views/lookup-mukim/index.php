                    ...
                    <div class="portlet light">
                        <div class="portlet-title">
                            <div class="caption font-green-haze">
                                ...
                                <span class="caption-subject bold uppercase"> Senarai Mukim</span>
                            </div>
                        ...
                        <p>
                        <?= Html::a('Create Lookup Mukim', ['create'], ['class' => 'btn btn-success']) ?>
                        </p>
                                      ...
                                      [
                                        ...
                                        'template'=>'{lihat} {kemaskini} {buang}',
                                            ...
                                            'urlCreator' => function ($action, $model, $key, $index) {
                                                if ($action === 'lihat') {
                                                    $url = ['lookup-mukim/view','id'=>$model->mukim_id];
                                                    return $url;
                                                }
                                                if ($action === 'kemaskini') {
                                                    $url = ['lookup-mukim/update','id'=>$model->mukim_id];
                                                    return $url;
                                                }
                                                if ($action === 'buang') {
                                                    $url = ['lookup-mukim/delete','id'=>$model->mukim_id];
                                                    return $url;
                                                }
                                            }
                                        ],
