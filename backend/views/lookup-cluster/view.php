...
$this->title = 'Lihat';
?>
<span id="clusterView" class="<?php echo Yii::$app->controller->id."/".Yii::$app->controller->action->id;?>"></span>
  <!-- BEGIN PAGE HEAD -->
    <div class="page-head">
        <div class="container">
            <!-- BEGIN PAGE TITLE -->
    ...
    <div class="page-content">
        <div class="container">
            ...
            <ul class="page-breadcrumb breadcrumb">
                ...
                <li class="active">Lihat Cluster : <?= strtoupper($model->cluster); ?></li>
            </ul>
            <!-- END PAGE BREADCRUMB -->
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="portlet light">
                        <div class="portlet-title">
                            <div class="caption font-green-haze">
                                ...
                                <span class="caption-subject bold uppercase"> Lihat Cluster </span>
                            </div>
                            <div class="actions">
                        ...
                        <div class="portlet-body" > 
                            <div class="form-body">
                                <h3 class="form-section">Maklumat Cluster</h3>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                            <span class="view"><?= $model->cluster  ?></span>
                                            </div>
                                        </div>
                                    </div>
