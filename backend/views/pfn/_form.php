                        ...
                        <div class="form-body">
                            ...
                            <div class="col-md-4">
                                <div class="form-group form-md-line-input">
                                    ...
                                    'onchange'=>'$.post( "'.Yii::$app->urlManager->createUrl(['pfn/listdistrict','id'=>'']).'"+$(this).val(), function( data ) {$( "select#district" ).html( data );});',
                            ...
                            <div class="col-md-4">
                                <div class="form-group form-md-line-input">
                                    ...
                                    [
                                        'prompt'=>'','id'=>'district',
                                        'onchange'=>'$.post( "'.Yii::$app->urlManager->createUrl(['pfn/listmukim','id'=>'']).'"+$(this).val(), function( data ) {$( "select#mukim" ).html( data );});',
                            ...
                            <div class="col-md-4">
                                <div class="form-group form-md-line-input">
                                    ...
                                    [
                                        'prompt'=>'','id'=>'mukim',
                                        'onchange'=>'$.post( "'.Yii::$app->urlManager->createUrl(['pfn/listsubbase','id'=>'']).'"+$(this).val(), function( data ) {$( "select#subbase" ).html( data );});',
                        ...
                        <div class="form-body">
                            ...
                            <div class="col-md-4">
                                <div class="form-group form-md-line-input">
                                    ...
                                    [
                                        'prompt'=>'','id'=>'subbase',
                                        'onchange'=>'$.post( "'.Yii::$app->urlManager->createUrl(['pfn/listcluster','id'=>'']).'"+$(this).val(), function( data ) {$( "select#cluster" ).html( data );});',
                                        'class'=>'form-control',
                            ...
                            <div class="col-md-4">
                                <div class="form-group form-md-line-input">
                                   <?= Html::activeDropDownList($model, 'cluster_id', $cluster, 
                                    [
                                        'prompt'=>'','id'=>'cluster',
                                        'onchange'=>'$.post( "'.Yii::$app->urlManager->createUrl(['pfn/listkampung','id'=>'']).'"+$(this).val(), function( data ) {$( "select#kampung" ).html( data );});',
                                        'class'=>'form-control',
