                    ...
                    <div class="portlet light">
                        <div class="portlet-title">
                            <div class="caption font-green-haze">
                                ...
                                <span class="caption-subject bold uppercase"> Senarai Maklumat Rangkaian Fasiliti Awam</span>
                            </div>
                            <div class="actions">
                        ...
                        <?php  echo $this->render('_search', ['model' => $searchModel]); ?>
                            <p>
                                <?= Html::a('Tambah Maklumat Rangkaian Fasiliti Awam', ['create'], ['class' => 'btn btn-success']) ?>
                            </p> 
                        <?= GridView::widget([
                                    ...
                                    [
                                        ...
                                        'template'=>'{lihat} {kemaskini} {buang}',
                                            ...
                                            'urlCreator' => function ($action, $model, $key, $index) {
                                                if ($action === 'lihat') {
                                                    $url = ['pfn/view','id'=>$model->pfn_id];
                                                    return $url;
                                                }
                                                if ($action === 'kemaskini') {
                                                    $url = ['pfn/update','id'=>$model->pfn_id];
                                                    return $url;
                                                }
                                                if ($action === 'buang') {
                                                    $url = ['pfn/delete','id'=>$model->pfn_id];
                                                    return $url;
                                                }
                                            }
                                        ],
