...
$this->title = 'Senarai Pfn Kategori';
?>
    <!-- BEGIN PAGE HEAD -->
    <div class="page-head">
        <div class="container">
                    ...
                    <div class="portlet light">
                        <div class="portlet-title">
                            <div class="caption font-green-haze">
                                ...
                                <span class="caption-subject bold uppercase"> Senarai Pfn Kategori</span>
                            </div>
                        ...
                        <p>
                        <?= Html::a('Create Lookup Pfn Kategori', ['create'], ['class' => 'btn btn-success']) ?>
                        </p>
                                      ...
                                      [
                                        ...
                                        'template'=>'{lihat} {kemaskini}',
                                            ...
                                            'urlCreator' => function ($action, $model, $key, $index) {
                                                if ($action === 'lihat') {
                                                    $url = ['lookup-pfn-category/view','id'=>$model->cat_id];
                                                    return $url;
                                                }
                                                if ($action === 'kemaskini') {
                                                    $url = ['lookup-pfn-category/update','id'=>$model->cat_id];
                                                    return $url;
                                                }
                                                /*if ($action === 'buang') {
