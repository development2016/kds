                    ...
                    <div class="portlet light">
                        <div class="portlet-title">
                            <div class="caption font-green-haze">
                                ...
                                <span class="caption-subject bold uppercase"> Senarai Kampung</span>
                            </div>
                       ...
                       <?php  echo $this->render('_search', ['model' => $searchModel]); ?>
                        ...
                        <p>
                        <?= Html::a('Create Lookup Kampung', ['create'], ['class' => 'btn btn-success']) ?>
                        </p>
                                      ...
                                      [
                                        ...
                                        'template'=>'{lihat} {kemaskini} {buang}',
                                            ...
                                            'urlCreator' => function ($action, $model, $key, $index) {
                                                if ($action === 'lihat') {
                                                    $url = ['lookup-kampung/view','id'=>$model->kampung_id];
                                                    return $url;
                                                }
                                                if ($action === 'kemaskini') {
                                                    $url = ['lookup-kampung/update','id'=>$model->kampung_id];
                                                    return $url;
                                                }
                                                if ($action === 'buang') {
                                                    $url = ['lookup-kampung/delete','id'=>$model->kampung_id];
                                                    return $url;
                                                }
                                            }
                                        ],
