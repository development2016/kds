...
$this->title = 'Senarai Perkahwinan';
?>
    <!-- BEGIN PAGE HEAD -->
    <div class="page-head">
        <div class="container">
                    ...
                    <div class="portlet light">
                        <div class="portlet-title">
                            <div class="caption font-green-haze">
                                ...
                                <span class="caption-subject bold uppercase"> Senarai Perkahwinan</span>
                            </div>
                            <div class="actions">
                        ...
                        <p>
                        <?= Html::a('Create Lookup Perkahwinan', ['create'], ['class' => 'btn btn-success']) ?>
                        </p>
                                      ...
                                      [
                                        ...
                                        'template'=>'{lihat} {kemaskini}',
                                            ...
                                            'urlCreator' => function ($action, $model, $key, $index) {
                                                if ($action === 'lihat') {
                                                    $url = ['lookup-perkahwinan/view','id'=>$model->id];
                                                    return $url;
                                                }
                                                if ($action === 'kemaskini') {
                                                    $url = ['lookup-perkahwinan/update','id'=>$model->id];
                                                    return $url;
                                                }
                                                /*if ($action === 'buang') {
