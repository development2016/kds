                    ...
                    <div class="portlet light">
                        <div class="portlet-title">
                            <div class="caption font-green-haze">
                                ...
                                <span class="caption-subject bold uppercase"> Senarai Sector</span>
                            </div>
                        ...
                        <p>
                        <?= Html::a('Create Lookup Sector', ['create'], ['class' => 'btn btn-success']) ?>
                        </p>
                                      ...
                                      [
                                        ...
                                        'template'=>'{lihat} {kemaskini}',
                                            ...
                                            'urlCreator' => function ($action, $model, $key, $index) {
                                                if ($action === 'lihat') {
                                                    $url = ['lookup-sector/view','id'=>$model->sector_id];
                                                    return $url;
                                                }
                                                if ($action === 'kemaskini') {
                                                    $url = ['lookup-sector/update','id'=>$model->sector_id];
                                                    return $url;
                                                }
                                                /*if ($action === 'buang') {
