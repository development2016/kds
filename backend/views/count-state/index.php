                                    ...
                                    [
                                        ...
                                        'template'=>'{calculate} {daerah}',
                                            'buttons' => [
                                                ...
                                                'daerah' => function ($url, $model) {
                                                    return Html::a('<span class="btn default btn-xs red-stripe">Daerah</span>', $url,[
                                                                'title'=> Yii::t('app','Daerah'),
                                                    ]);
                                            ...
                                            'urlCreator' => function ($action, $model, $key, $index) {
                                                if ($action === 'calculate') {
                                                    $url = ['count-state/calculate','id'=>$model->state_id];
                                                    return $url;
                                                }
                                                if ($action === 'daerah') {
                                                    $url = ['count-district/index','id'=>$model->state_id];
                                                    return $url;
                                                }
