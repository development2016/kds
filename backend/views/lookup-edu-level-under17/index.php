...
$this->title = 'Senarai Edu Level Under 17';
?>
    <!-- BEGIN PAGE HEAD -->
    <div class="page-head">
        <div class="container">
                    ...
                    <div class="portlet light">
                        <div class="portlet-title">
                            <div class="caption font-green-haze">
                                ...
                                <span class="caption-subject bold uppercase"> Senarai Edu Level Under 17</span>
                            </div>
                        ...
                        <p>
                        <?= Html::a('Create Lookup Edu Level Under 17', ['create'], ['class' => 'btn btn-success']) ?>
                        </p>
                                      ...
                                      [
                                        ...
                                        'template'=>'{lihat} {kemaskini}',
                                            ...
                                            'urlCreator' => function ($action, $model, $key, $index) {
                                                if ($action === 'lihat') {
                                                    $url = ['lookup-edu-level-under17/view','id'=>$model->id];
                                                    return $url;
                                                }
                                                if ($action === 'kemaskini') {
                                                    $url = ['lookup-edu-level-under17/update','id'=>$model->id];
                                                    return $url;
                                                }
                                                /*if ($action === 'buang') {
