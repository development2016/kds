                    ...
                    <div class="portlet light">
                        <div class="portlet-title">
                            <div class="caption font-green-haze">
                                ...
                                <span class="caption-subject bold uppercase"> Senarai Pfn Rating</span>
                            </div>
                        ...
                        <p>
                        <?= Html::a('Create Lookup Pfn Rating', ['create'], ['class' => 'btn btn-success']) ?>
                        </p>
                                      ...
                                      [
                                        ...
                                        'template'=>'{lihat} {kemaskini}',
                                            ...
                                            'urlCreator' => function ($action, $model, $key, $index) {
                                                if ($action === 'lihat') {
                                                    $url = ['lookup-pfn-rating/view','id'=>$model->rating_id];
                                                    return $url;
                                                }
                                                if ($action === 'kemaskini') {
                                                    $url = ['lookup-pfn-rating/update','id'=>$model->rating_id];
                                                    return $url;
                                                }
                                                /*if ($action === 'buang') {
