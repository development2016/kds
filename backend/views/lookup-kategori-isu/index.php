...
$this->title = 'Senarai Kategori Isu';
?>
    <!-- BEGIN PAGE HEAD -->
    <div class="page-head">
        <div class="container">
                    ...
                    <div class="portlet light">
                        <div class="portlet-title">
                            <div class="caption font-green-haze">
                                ...
                                <span class="caption-subject bold uppercase"> Senarai Kategori Isu</span>
                            </div>
                            <div class="actions">
                        ...
                        <p>
                        <?= Html::a('Create Lookup Kategori Isu', ['create'], ['class' => 'btn btn-success']) ?>
                        </p>
                                      ...
                                      [
                                        ...
                                        'template'=>'{lihat} {kemaskini}',
                                            ...
                                            'urlCreator' => function ($action, $model, $key, $index) {
                                                if ($action === 'lihat') {
                                                    $url = ['lookup-kategori-isu/view','id'=>$model->kategori_id];
                                                    return $url;
                                                }
                                                if ($action === 'kemaskini') {
                                                    $url = ['lookup-kategori-isu/update','id'=>$model->kategori_id];
                                                    return $url;
                                                }
                                                /*if ($action === 'buang') {
