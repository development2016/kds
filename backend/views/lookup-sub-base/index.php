                    ...
                    <div class="portlet light">
                        <div class="portlet-title">
                            <div class="caption font-green-haze">
                                ...
                                <span class="caption-subject bold uppercase"> Senarai Subbase</span>
                            </div>
                        ...
                        <p>
                        <?= Html::a('Create Lookup Subbase', ['create'], ['class' => 'btn btn-success']) ?>
                        </p>
                                      ...
                                      [
                                        ...
                                        'template'=>'{lihat} {kemaskini} {buang}',
                                            ...
                                            'urlCreator' => function ($action, $model, $key, $index) {
                                                if ($action === 'lihat') {
                                                    $url = ['lookup-sub-base/view','id'=>$model->sub_base_id];
                                                    return $url;
                                                }
                                                if ($action === 'kemaskini') {
                                                    $url = ['lookup-sub-base/update','id'=>$model->sub_base_id];
                                                    return $url;
                                                }
                                                if ($action === 'buang') {
                                                    $url = ['lookup-sub-base/delete','id'=>$model->sub_base_id];
                                                    return $url;
                                                }
                                            }
                                        ],
